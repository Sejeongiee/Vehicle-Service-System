...
INSERT INTO `customers` (`id`, `legacy_user_id`, `fullname`, `email`, `phone`, `address`, `created_at`) VALUES
(1, 5, 'Patrice S.F. Guinto', 'kindredjeb@gmail.com', NULL, NULL, '2026-08-27 06:55:56'),
(2, 6, 'karl', 'karl@gmail.com', NULL, NULL, '2026-08-27 06:55:56'),
(10, NULL, 'Jay', 'kindredjebgold@gmail.com', '+639451250831', NULL, '2026-08-27 07:33:40');
...
INSERT INTO `reservations` (`id`, `reference_number`, `user_id`, `customer_id`, `vehicle_id`, `service_type`, `appointment_date`, `appointment_time`, `remarks`, `status`, `mechanic_id`, `created_at`) VALUES
(1, NULL, 6, 2, 5, 'Oil Change', '2027-04-16', '19:41:00', 'haktog', 'Completed', NULL, '2026-08-12 18:36:12'),
(3, NULL, 5, 1, 8, 'General Maintenance', '2026-09-10', '14:34:00', 'just general maintenance', 'Completed', NULL, '2026-08-13 06:34:49'),
(4, NULL, 5, 1, 9, 'General Maintenance', '2026-10-09', '19:03:00', 'kasi inom ng inom ng coke kaya kaya kailangan magpageneral check up para makita kung anong problema ng aking system', 'Cancelled', NULL, '2026-08-13 11:04:01'),
(5, NULL, 5, 1, 9, 'Oil Change', '2026-10-09', '08:00:00', 'need oil change mabaho na siya', 'Completed', 2, '2026-08-16 15:51:15'),
(6, NULL, 5, 1, 9, 'General Maintenance', '2026-10-09', '09:29:00', '', 'Completed', 4, '2026-08-18 01:29:12'),
(7, NULL, 5, 1, 9, 'General Maintenance', '2026-10-09', '22:33:00', '', 'Completed', 4, '2026-08-18 02:33:53'),
(8, NULL, 5, 1, 9, 'Engine Check', '2026-08-20', '08:00:00', 'may sira ang engine', 'Completed', 1, '2026-08-19 10:22:43'),
(9, NULL, 5, 1, 8, 'Engine Check', '2026-10-20', '08:30:00', '', 'Completed', 4, '2026-08-19 10:27:19'),
(10, 'VSMS-20260827-E7D9A7', NULL, 10, 11, 'Tire Service', '2027-08-31', '08:00:00', 'dont know', 'Pending', NULL, '2026-08-27 07:33:40');
...
INSERT INTO `vehicles` (`id`, `user_id`, `customer_id`, `brand`, `model`, `year`, `plate_number`, `color`, `created_at`) VALUES
(5, 6, 2, 'toyota', 'inova', '2001', 'nbx 9268', 'black', '2026-08-12 18:32:13'),
(8, 5, 1, 'toyota', 'inova', '2026', 'nbx 9268', 'black', '2026-08-13 03:24:14'),
(9, 5, 1, 'Suzuki', 'Celerio', '2013', 'fpj 0516', 'white', '2026-08-13 11:01:52'),
(11, NULL, 10, 'toyota', 'inova', '2019', 'NBX 9268', 'black', '2026-08-27 07:33:40');
...
ALTER TABLE `customers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `legacy_user_id` (`legacy_user_id`),
