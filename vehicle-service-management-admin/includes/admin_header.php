...
<head>
    ...
    <title>
        LUCKY YUNA CAR CARE CENTER - Admin
    </title>
...
<body>
   ...
   style="background-color: #dc2626; color: white; font-weight: bold; padding: 10px 18px; text-decoration: none; border-radius: 6px; display: inline-block;">
    🚪 Logout
</a>
                </li>
